...
export const FeedIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <rect x="4" y="4" width="16" height="6" rx="2" ry="2"></rect>
        <rect x="4" y="14" width="16" height="6" rx="2" ry="2"></rect>
    </svg>
);

export const FeedFilledIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const MessageFilledIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
